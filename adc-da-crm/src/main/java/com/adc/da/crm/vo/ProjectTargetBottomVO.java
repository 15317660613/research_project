 ...
 */
public class ProjectTargetBottomVO extends BaseEntity {
    ...
    private List<MonthBudgetEO> monthBudgetEOList = new ArrayList<>();
    ...
    public List<MonthBudgetEO> getMonthBudgetEOList() {
        return monthBudgetEOList;
    }

    public void setMonthBudgetEOList(List<MonthBudgetEO> monthBudgetEOList) {
        this.monthBudgetEOList = monthBudgetEOList;
    }
}
