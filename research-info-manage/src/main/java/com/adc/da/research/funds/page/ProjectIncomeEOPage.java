...
/**
 * <b>功能：</b>RS_PROJECT_INCOME ProjectIncomeEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2020-11-11 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class ProjectIncomeEOPage extends BasePage {
    ...
    private String incomeAmountOperator = "=";
    private String incomeDate;
    private String incomeDate1;
    private String incomeDate2;
    private String incomeDateOperator = "=";
    ...
    private String incomeAmountBegin;
    private String incomeAmountEnd;
    private String incomeDateBegin;
    ...
    public String getIncomeAmountOperator() {
        return this.incomeAmountOperator;
    }

    public void setIncomeAmountOperator(String incomeAmountOperator) {
        this.incomeAmountOperator = incomeAmountOperator;
    }
    ...
    public String getIncomeDate2() {
        return this.incomeDate2;
    }

    public void setIncomeDate2(String incomeDate2) {
        this.incomeDate2 = incomeDate2;
    }

    public String getIncomeDateOperator() {
        return this.incomeDateOperator;
    }

    public void setIncomeDateOperator(String incomeDateOperator) {
        this.incomeDateOperator = incomeDateOperator;
    }
    ...
    public String getIncomeAmountBegin() {
        return incomeAmountBegin;
    }

    public void setIncomeAmountBegin(String incomeAmountBegin) {
        this.incomeAmountBegin = incomeAmountBegin;
    }

    public String getIncomeAmountEnd() {
        return incomeAmountEnd;
    }

    public void setIncomeAmountEnd(String incomeAmountEnd) {
        this.incomeAmountEnd = incomeAmountEnd;
    }

    public String getIncomeDateBegin() {
        return incomeDateBegin;
    }

    public void setIncomeDateBegin(String incomeDateBegin) {
        this.incomeDateBegin = incomeDateBegin;
    }
