package com.adc.da.ext.sys.log.vo;
 ...
 */
public class LogVOExt extends BaseEntity {
    ...
    public String getUserDeptNames() {
        return userDeptNames;
    }

    public void setUserDeptNames(String userDeptNames) {
