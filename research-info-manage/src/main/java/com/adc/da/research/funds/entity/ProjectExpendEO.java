...
/**
 * <b>功能：</b>RS_PROJECT_EXPEND ProjectExpendEOEntity<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2020-11-12 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class ProjectExpendEO extends BaseEntity {
     ...
     * <li>expendAmount -> expend_amount</li>
     * <li>expendDate -> expend_date</li>
    ...
    public static String fieldToColumn(String fieldName) {
        ...
        switch (fieldName) {
            ...
            case "expendAmount": return "expend_amount";
            case "expendDate": return "expend_date";
            ...
            case "expendType":return "expendType";
            default : return null;
        }
    }
     ...
     * <li>expend_amount -> expendAmount</li>
     * <li>expend_date -> expendDate</li>
     * <li>summary -> summary</li>
    ...
    public static String columnToField(String columnName) {
        ...
        switch (columnName) {
            ...
            case "expend_amount": return "expendAmount";
            case "expend_date": return "expendDate";
            case "summary": return "summary";
