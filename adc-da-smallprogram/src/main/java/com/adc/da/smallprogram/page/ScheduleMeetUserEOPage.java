...
/**
 * <b>功能：</b>TS_SCHEDULE_MEET_USER ScheduleMeetUserEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2019-11-26 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class ScheduleMeetUserEOPage extends BasePage {
    ...
    private String collectedOperator = "=";
    private String status;
    private String statusOperator = "=";
    private String meetId;
    private String meetIdOperator = "=";
    private String finishedTime;
    private String finishedTime1;
    private String finishedTime2;
    private String finishedTimeOperator = "=";
    ...
    public String getCollectedOperator() {
        return this.collectedOperator;
    }

    public void setCollectedOperator(String collectedOperator) {
        this.collectedOperator = collectedOperator;
    }
    ...
    public String getMeetIdOperator() {
        return this.meetIdOperator;
    }

    public void setMeetIdOperator(String meetIdOperator) {
        this.meetIdOperator = meetIdOperator;
    }
    ...
    public String getFinishedTime2() {
        return this.finishedTime2;
    }

    public void setFinishedTime2(String finishedTime2) {
        this.finishedTime2 = finishedTime2;
    }

    public String getFinishedTimeOperator() {
        return this.finishedTimeOperator;
    }

    public void setFinishedTimeOperator(String finishedTimeOperator) {
        this.finishedTimeOperator = finishedTimeOperator;
    }
