...
/**
 * <b>功能：</b>RS_FUND_RULES FundRulesEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2020-10-26 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class FundRulesEOPage extends BasePage {

    private String id;
    private String idOperator = "=";
    private String fundTemplateName;
    private String fundTemplateNameOperator = "=";
    ...
    public String getFundTemplateNameOperator() {
        return this.fundTemplateNameOperator;
    }

    public void setFundTemplateNameOperator(String fundTemplateNameOperator) {
        this.fundTemplateNameOperator = fundTemplateNameOperator;
    }
