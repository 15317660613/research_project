...
/**
 * <b>功能：</b>RS_CHECK_TARGET CheckTargetEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2020-10-30 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class CheckTargetEOPage extends BasePage {
    ...
    private String checkTypeIdOperator = "=";
    private String checkName;
    private String checkNameOperator = "=";
    private String checkNum;
    private String checkNumOperator = "=";
    private String finishedNum;
    private String finishedNumOperator = "=";
    ...
    private String deliverableNameOperator = "=";
    private String deliverableTarget;
    private String deliverableTargetOperator = "=";
    ...
    public String getDeliverableNameOperator() {
        return deliverableNameOperator;
    }

    public void setDeliverableNameOperator(String deliverableNameOperator) {
        this.deliverableNameOperator = deliverableNameOperator;
    }
    ...
    public String getDeliverableTargetOperator() {
        return deliverableTargetOperator;
    }

    public void setDeliverableTargetOperator(String deliverableTargetOperator) {
        this.deliverableTargetOperator = deliverableTargetOperator;
    }
    ...
    public String getCheckTypeIdOperator() {
        return this.checkTypeIdOperator;
    }

    public void setCheckTypeIdOperator(String checkTypeIdOperator) {
        this.checkTypeIdOperator = checkTypeIdOperator;
    }
    ...
    public String getCheckNameOperator() {
        return this.checkNameOperator;
    }

    public void setCheckNameOperator(String checkNameOperator) {
        this.checkNameOperator = checkNameOperator;
    }
    ...
    public String getCheckNumOperator() {
        return this.checkNumOperator;
    }

    public void setCheckNumOperator(String checkNumOperator) {
        this.checkNumOperator = checkNumOperator;
    }
    ...
    public String getFinishedNumOperator() {
        return this.finishedNumOperator;
    }

    public void setFinishedNumOperator(String finishedNumOperator) {
        this.finishedNumOperator = finishedNumOperator;
    }
