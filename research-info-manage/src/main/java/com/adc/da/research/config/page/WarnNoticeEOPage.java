package com.adc.da.research.config.page;

import com.adc.da.base.page.BasePage;

/**
 * <b>功能：</b>RS_WARN_NOTICE WarnNoticeEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2020-10-29 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class WarnNoticeEOPage extends BasePage {
    ...
    private String nationalLowestProgressOperator = "=";
    private String selfLowestProgress;
    private String selfLowestProgressOperator = "=";
    private String warnCotent;
    private String warnCotentOperator = "=";
    ...
    public String getNationalLowestProgressOperator() {
        return this.nationalLowestProgressOperator;
    }

    public void setNationalLowestProgressOperator(String nationalLowestProgressOperator) {
        this.nationalLowestProgressOperator = nationalLowestProgressOperator;
    }
    ...
    public String getSelfLowestProgressOperator() {
        return this.selfLowestProgressOperator;
    }

    public void setSelfLowestProgressOperator(String selfLowestProgressOperator) {
        this.selfLowestProgressOperator = selfLowestProgressOperator;
    }
    ...
    public String getWarnCotentOperator() {
        return this.warnCotentOperator;
    }

    public void setWarnCotentOperator(String warnCotentOperator) {
        this.warnCotentOperator = warnCotentOperator;
    }
