 ...
 */
public class RatingRulesEO extends BaseEntity {
     ...
     * <p>字段列表：</p>
     * <li>id -> id</li>
     * <li>ratingRulesName -> rating_rules_name</li>
    ...
    public static String fieldToColumn(String fieldName) {
        ...
        switch (fieldName) {
            case "id": return "id";
            case "ratingRulesName": return "rating_rules_name";
     ...
     * <p>字段列表：</p>
     * <li>id -> id</li>
     * <li>rating_rules_name -> ratingRulesName</li>
    ...
    public static String columnToField(String columnName) {
        ...
        switch (columnName) {
            case "id": return "id";
            case "rating_rules_name": return "ratingRulesName";
