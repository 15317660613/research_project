...
/**
 * <b>功能：</b>RS_EXPERT_USER_INFO ExpertUserInfoEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2020-10-27 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class ExpertUserInfoEOPage extends BasePage {

    private String expertTypeId;
    private String expertTypeIdOperator = "=";
    private String id;
    ...
    private String expertGroupIdOperator = "=";
    private String resume;
    private String resumeOperator = "=";
    private String researchDirection;
    private String researchDirectionOperator = "=";
    ...
    public String getExpertTypeIdOperator() {
        return this.expertTypeIdOperator;
    }

    public void setExpertTypeIdOperator(String expertTypeIdOperator) {
        this.expertTypeIdOperator = expertTypeIdOperator;
    }
    ...
    public String getCompanyNameOperator() {
        return this.companyNameOperator;
    }
    ...
    public String getExpertGroupIdOperator() {
        return this.expertGroupIdOperator;
    }

    public void setExpertGroupIdOperator(String expertGroupIdOperator) {
        this.expertGroupIdOperator = expertGroupIdOperator;
    }
    ...
    public String getResumeOperator() {
        return this.resumeOperator;
    }

    public void setResumeOperator(String resumeOperator) {
        this.resumeOperator = resumeOperator;
    }
    ...
    public String getResearchDirectionOperator() {
        return this.researchDirectionOperator;
    }

    public void setResearchDirectionOperator(String researchDirectionOperator) {
        this.researchDirectionOperator = researchDirectionOperator;
    }
