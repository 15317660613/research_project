...
import static com.adc.da.budget.constant.ProjectSearchField.BUDGET_DOMAIN_ID;
import static com.adc.da.budget.constant.ProjectSearchField.CONTRACT_NO;
...
public class CommonUtil {
     ...
     * @return
     */
    public static List<Map<String, String>> userMapKv(List<UserEPEntity> userList) {
        List<Map<String, String>> mapList = new ArrayList<>();
        for (UserEPEntity user : userList) {
            Map<String, String> map = new HashMap<>();
            map.put("id", user.getUsid());
            map.put("name", user.getUsname());
            mapList.add(map);
        }
        return mapList;
    }
    ...
    public static BoolQueryBuilder queryByContractNoAndBudgetDomainId(String contractNO, String budgetDomainId) {
        return QueryBuilders.boolQuery().must(QueryBuilders.matchQuery(CONTRACT_NO, contractNO))
                            .must(QueryBuilders.termsQuery(BUDGET_DOMAIN_ID, budgetDomainId));
