...
/**
 * <b>功能：</b>RS_RESEARCH_BUDGET_DETAIL ResearchBudgetDetailEOEntity<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2020-11-27 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class ResearchBudgetDetailEO extends BaseEntity {

    private String model;  //型号
    private String function; //功能
    private String entrustedUnit;//受委托单位
    private Integer peopleNum;//人数
    private Integer dayNum;//天数
    private String exchangePlace;//交流地
    private String participateHost;//举办/参加
    private Double totalPrice;//总额
    private Integer delFlag;
    private String id;
    private String researchProjectId;//科研项目ID
    private String detailType;//类型
    private String name;//名称
    private Integer count;//总数/数量/次数
    private String unit;//单位
    private Double unitPrice;//单价/金额(每人次)
