 ...
 */
public class EventEOPage extends BasePage {
    ...
    private String sendFlagOperator = "=";
    ...
    public String getSendFlagOperator() {
        return this.sendFlagOperator;
    }

    public void setSendFlagOperator(String sendFlagOperator) {
        this.sendFlagOperator = sendFlagOperator;
    }
