 ...
 */
@Data
public class BusinessGonfigDto implements IExcelModel, IExcelDataModel {

    @Excel(name = "*业务名称",orderNum = "1",width = 50)
    @NotNull(message = "业务名称不能为空！")
    private String bgName;
    @Excel(name = "*业务编号",orderNum = "2",width = 30)
    @NotNull(message = "业务编号不能为空！")
    private String bgNumber;
    @Excel(name = "*负责部门",orderNum = "3",width = 30)
    @NotNull(message = "负责部门不能为空！")
    private String departName;
    @Excel(name = "*业务状态",orderNum = "4",width = 15)
