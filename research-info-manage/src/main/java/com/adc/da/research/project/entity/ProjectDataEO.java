 ...
 */
public class ProjectDataEO extends BaseEntity {
    ...
    private String toCheck;//待检查标识--项目执行
    private String inCheck;//检查中标识--项目执行


    private String currentJudgeStatus;//评审状态
    ...
    private String budgetsum; //经费用（中汽中心当年预算）
    ...
    public String getCurrentJudgeStatus() {
        return currentJudgeStatus;
    }

    public void setCurrentJudgeStatus(String currentJudgeStatus) {
        this.currentJudgeStatus = currentJudgeStatus;
    }
}
