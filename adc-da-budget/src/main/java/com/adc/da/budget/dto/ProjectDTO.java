...
public class ProjectDTO extends Project {
     ...
     * 开始时间
     */
    @Excel(name = "开始时间-导入", orderNum = "3", type = 1)
     ...
     * 所属业务
     */
    @Excel(name = "所属业务", orderNum = "8")
    private String budget;
    
    /**
     * 业务类型
     */
    @Excel(name = "业务类型", orderNum = "9")
     ...
     * 合同金额
     */
    @Excel(name = "合同金额", orderNum = "13")
    private float contractAmount;

    /**
     * 开始时间
     */
    @Excel(name = "项目开始时间-导入", orderNum = "14")
    private String projectBeginTimeStr;

    /**
     * 结束时间
     */
    @Excel(name = "项目结束时间-导入", orderNum = "15")
