...
/**
 * <b>功能：</b>RS_WORK_PROGRESS_HISTORY WorkProgressHistoryEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2020-12-04 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class WorkProgressHistoryEOPage extends BasePage {
    ...
    private String nodeGoalsOperator = "=";
    ...
    private String checkUserOperator = "=";
    private String checkResult;
    private String checkResultOperator = "=";
    private String checkUserId;
    private String checkUserIdOperator = "=";
    ...
    public String getNodeGoalsOperator() {
        return this.nodeGoalsOperator;
    }

    public void setNodeGoalsOperator(String nodeGoalsOperator) {
        this.nodeGoalsOperator = nodeGoalsOperator;
    }
    ...
    public String getApproveCommentOperator() {
        return this.approveCommentOperator;
    }
    ...
    public String getCheckMethodOperator() {
        return this.checkMethodOperator;
    }
    ...
    public String getCheckUserOperator() {
        return this.checkUserOperator;
    }

    public void setCheckUserOperator(String checkUserOperator) {
        this.checkUserOperator = checkUserOperator;
    }
    ...
    public String getCheckResultOperator() {
        return this.checkResultOperator;
    }

    public void setCheckResultOperator(String checkResultOperator) {
        this.checkResultOperator = checkResultOperator;
    }
    ...
    public String getCheckUserIdOperator() {
        return this.checkUserIdOperator;
    }

    public void setCheckUserIdOperator(String checkUserIdOperator) {
        this.checkUserIdOperator = checkUserIdOperator;
    }
