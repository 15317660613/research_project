...
/**
 * <b>功能：</b>RS_MEMBER_INFO_HISTORY MemberInfoHistoryEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2020-12-04 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class MemberInfoHistoryEOPage extends BasePage {
    ...
    private String memberUserIdOperator = "=";
    private String undertakingTypeId;
    private String undertakingTypeIdOperator = "=";
    ...
    private String taskDivisionOperator = "=";
    private String workHours;
    private String workHoursOperator = "=";
    private String studyAbroadType;
    private String studyAbroadTypeOperator = "=";
    private String sort;
    private String sortOperator = "=";
    private String memberProfession;
    private String memberProfessionOperator = "=";
    ...
    public String getMemberUserIdOperator() {
        return this.memberUserIdOperator;
    }

    public void setMemberUserIdOperator(String memberUserIdOperator) {
        this.memberUserIdOperator = memberUserIdOperator;
    }
    ...
    public String getUndertakingTypeIdOperator() {
        return this.undertakingTypeIdOperator;
    }

    public void setUndertakingTypeIdOperator(String undertakingTypeIdOperator) {
        this.undertakingTypeIdOperator = undertakingTypeIdOperator;
    }
    ...
    public String getTaskDivisionOperator() {
        return this.taskDivisionOperator;
    }

    public void setTaskDivisionOperator(String taskDivisionOperator) {
        this.taskDivisionOperator = taskDivisionOperator;
    }
    ...
    public String getWorkHoursOperator() {
        return this.workHoursOperator;
    }

    public void setWorkHoursOperator(String workHoursOperator) {
        this.workHoursOperator = workHoursOperator;
    }
    ...
    public String getStudyAbroadTypeOperator() {
        return this.studyAbroadTypeOperator;
    }

    public void setStudyAbroadTypeOperator(String studyAbroadTypeOperator) {
        this.studyAbroadTypeOperator = studyAbroadTypeOperator;
    }
    ...
    public String getMemberProfessionOperator() {
        return this.memberProfessionOperator;
    }

    public void setMemberProfessionOperator(String memberProfessionOperator) {
        this.memberProfessionOperator = memberProfessionOperator;
    }
