...
@Component
@Slf4j
public class SetSDTStaffListener implements ExecutionListener {
    ...
    public void notify(DelegateExecution delegateExecution) throws Exception {
        ...
        if (map != null) {
            ...
            String deptId = map.get(idList.get(1));
            if (StringUtils.isNotEmpty(deptId)) {
                delegateExecution.setVariable("STDStaff", deptId);
            } else {
            ...
            log.warn("SetActDeptIDListener globalFormData   is null");
            throw new AdcDaBaseException(ErrorType.TASK_GET_FORM_ERROR);
        }
    }
