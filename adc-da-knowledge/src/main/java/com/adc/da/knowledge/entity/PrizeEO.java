...
public class PrizeEO extends BaseEntity {
    ...
    private String id;
    private String num;
    @Excel(name = "奖项名称",orderNum = "3")
    private String prizeName;
    @Excel(name = "获奖项目名称",orderNum = "2")
    private String projectName;
    @Excel(name = "获奖等级",orderNum = "4")
    private String level;
    @Excel(name = "获奖时间",orderNum = "5",exportFormat = "yyyy-MM-dd HH:mm:ss")
    @org.springframework.format.annotation.DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
    private Date prizeTime;
    @Excel(name = "颁发单位",orderNum = "6")
    private String issuedDept;
    @Excel(name = "获奖人",orderNum = "7")
    private String belongedUserName;
    private String belongedUserId;
    @Excel(name = "部门",orderNum = "8")
    private String deptName;
    private String deptId;
    @Excel(name = "更新时间",orderNum = "10",exportFormat = "yyyy-MM-dd HH:mm:ss")
    @org.springframework.format.annotation.DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
    private Date updateTime;
    @Excel(name = "上传人",orderNum = "9")
