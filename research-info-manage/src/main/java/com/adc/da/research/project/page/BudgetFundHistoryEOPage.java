...
/**
 * <b>功能：</b>RS_BUDGET_FUND_HISTORY BudgetFundHistoryEOPage<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2020-12-01 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class BudgetFundHistoryEOPage extends BasePage {

    private String changeUser;
    private String changeUserOperator = "=";
    private String changeUserId;
    private String changeUserIdOperator = "=";
    private String id;
    ...
    public String getChangeUserOperator() {
        return this.changeUserOperator;
    }

    public void setChangeUserOperator(String changeUserOperator) {
        this.changeUserOperator = changeUserOperator;
    }
    ...
    public String getChangeUserIdOperator() {
        return this.changeUserIdOperator;
    }

    public void setChangeUserIdOperator(String changeUserIdOperator) {
        this.changeUserIdOperator = changeUserIdOperator;
    }
