 ...
 */
@Data
public class BudgetEO extends BaseEntity implements Comparable<BudgetEO> {

    public int compareTo(BudgetEO o) {
        return Collator.getInstance(java.util.Locale.CHINA).compare(this.getProjectName(), o.getProjectName());
    }
    ...
    //当前年份实际收入
    private Double currentYearEstimate=0.0d;

    //当前年份实际合同
    private Double currentYearDeal=0.0d;
    ...
    public static String fieldToColumn(String fieldName) {
        ...
        switch (fieldName) {
            ...
            case "currentYear":
                return "current_year";
            case "currentYearDeal":
                return "current_year_deal";
            case "currentYearEstimate":
                return "current_year_estimate";
            case "nextYear1Deal":
                return "next_year_1_deal";
            case "nextYear1Income":
                return "next_year_1_income";
            case "nextYear2Deal":
                return "next_year_2_deal";
            case "nextYear2Income":
                return "next_year_2_income";
            case "nextYear3Deal":
                return "next_year_3_deal";
            case "nextYear3Income":
                return "next_year_3_income";
            case "nextYear4Deal":
                return "next_year_4_deal";
            case "nextYear4Income":
                return "next_year_4_income";
            case "nextYear5Deal":
                return "next_year_5_deal";
            case "nextYear5Income":
                return "next_year_5_income";
            case "nextYear6Deal":
                return "next_year_6_deal";
            case "nextYear6Income":
                return "next_year_6_income";
            case "nextYear7Deal":
                return "next_year_7_deal";
            case "nextYear7Income":
                return "next_year_7_income";
            case "nextYear8Deal":
                return "next_year_8_deal";
            case "nextYear8Income":
                return "next_year_8_income";
            case "nextYear9Deal":
                return "next_year_9_deal";
            case "nextYear9Income":
                return "next_year_9_income";
            case "nextYear10Deal":
                return "next_year_10_deal";
            case "nextYear10Income":
                return "next_year_10_income";
            case "nextYear11Deal":
                return "next_year_11_deal";
            case "nextYear11Income":
                return "next_year_11_income";
            case "nextYear12Deal":
                return "next_year_12_deal";
            case "nextYear12Income":
                return "next_year_12_income";
            case "remark":
                return "remark";
            case "businessAdminId":
                return "business_admin_id";
            case "businessAdminName":
                return "business_admin_name";
            case "deptName":
                return "dept_name";
            default:
                return null;
    ...
    public static String columnToField(String columnName) {
        ...
        switch (columnName) {
            ...
            case "current_year":
                return "currentYear";
            case "current_year_deal":
                return "currentYearDeal";
            case "current_year_estimate":
                return "currentYearEstimate";
            case "next_year_1_deal":
                return "nextYear1Deal";
            case "next_year_1_income":
                return "nextYear1Income";
            case "next_year_2_deal":
                return "nextYear2Deal";
            case "next_year_2_income":
                return "nextYear2Income";
            case "next_year_3_deal":
                return "nextYear3Deal";
            case "next_year_3_income":
                return "nextYear3Income";
            case "next_year_4_deal":
                return "nextYear4Deal";
            case "next_year_4_income":
                return "nextYear4Income";
            case "next_year_5_deal":
                return "nextYear5Deal";
            case "next_year_5_income":
                return "nextYear5Income";
            case "next_year_6_deal":
                return "nextYear6Deal";
            case "next_year_6_income":
                return "nextYear6Income";
            case "next_year_7_deal":
                return "nextYear7Deal";
            case "next_year_7_income":
                return "nextYear7Income";
            case "next_year_8_deal":
                return "nextYear8Deal";
            case "next_year_8_income":
                return "nextYear8Income";
            case "next_year_9_deal":
                return "nextYear9Deal";
            case "next_year_9_income":
                return "nextYear9Income";
            case "next_year_10_deal":
                return "nextYear10Deal";
            case "next_year_10_income":
                return "nextYear10Income";
            case "next_year_11_deal":
                return "nextYear11Deal";
            case "next_year_11_income":
                return "nextYear11Income";
            case "next_year_12_deal":
                return "nextYear12Deal";
            case "next_year_12_income":
                return "nextYear12Income";
            case "remark":
                return "remark";
            case "dept_name":
                return "deptName";
            case "business_admin_id":
                return "businessAdminId";
            case "business_admin_name":
