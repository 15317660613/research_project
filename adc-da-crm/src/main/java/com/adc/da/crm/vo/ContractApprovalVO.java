 ...
 */
public class ContractApprovalVO extends BaseEntity {
    ...
    private List<ContractInfoEO> contractInfoEOList = new ArrayList<>();
    @MatchFieldCollection
    ...
    public List<ContractInfoEO> getContractInfoEOList() {
        return contractInfoEOList;
    }

    public void setContractInfoEOList(List<ContractInfoEO> contractInfoEOList) {
        this.contractInfoEOList = contractInfoEOList;
    }
