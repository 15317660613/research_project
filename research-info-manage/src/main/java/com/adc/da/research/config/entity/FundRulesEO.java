...
/**
 * <b>功能：</b>RS_FUND_RULES FundRulesEOEntity<br>
 * <b>作者：</b>code generator<br>
 * <b>日期：</b> 2020-10-26 <br>
 * <b>版权所有：<b>版权归北京卡达克数据技术中心所有。<br>
 */
public class FundRulesEO extends BaseEntity {
     ...
     * <p>字段列表：</p>
     * <li>id -> id</li>
     * <li>fundTemplateName -> fund_template_name</li>
    ...
    public static String fieldToColumn(String fieldName) {
        ...
        switch (fieldName) {
            case "id": return "id";
            case "fundTemplateName": return "fund_template_name";
     ...
     * <p>字段列表：</p>
     * <li>id -> id</li>
     * <li>fund_template_name -> fundTemplateName</li>
    ...
    public static String columnToField(String columnName) {
        ...
        switch (columnName) {
            case "id": return "id";
            case "fund_template_name": return "fundTemplateName";
