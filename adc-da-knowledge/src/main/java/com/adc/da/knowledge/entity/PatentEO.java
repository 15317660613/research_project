 ...
 */
public class PatentEO extends BaseEntity {
    ...
    private String id;
    @Excel(name = "专利类型",orderNum = "2")
    private String type;
    @Excel(name = "专利名称",orderNum = "3")
    private String name;
    @Excel(name = "专利号",orderNum = "5")
    private String num;
    @Excel(name = "专利申请日",orderNum = "6",exportFormat = "yyyy-MM-dd HH:mm:ss")
    @org.springframework.format.annotation.DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
    private Date applyDate;
    @Excel(name = "专利权人",orderNum = "7")
    private String belongUserName;
    private String belongUserId;
    @Excel(name = "授权公告日",orderNum = "8",exportFormat = "yyyy-MM-dd HH:mm:ss")
    @org.springframework.format.annotation.DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
    private Date authorizeDate;
    @Excel(name = "授权公告号",orderNum = "9")
    private String authorizeNum;
    @Excel(name = "证书号",orderNum = "10")
    private String certificateNum;
    private String uploadUserId;
    @Excel(name = "设计人",orderNum = "4")
