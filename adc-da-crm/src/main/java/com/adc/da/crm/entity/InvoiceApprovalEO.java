 ...
 */
public class InvoiceApprovalEO extends BaseEntity {
     ...
     * <li>meter -> meter</li>
     * <li>outNo -> out_no</li>
     * <li>approvalView -> approval_view</li>
    ...
    public static String fieldToColumn(String fieldName) {
        ...
        switch (fieldName) {
            ...
            case "approvalView": return "approval_view";
     ...
     * <li>meter -> meter</li>
     * <li>out_no -> outNo</li>
     * <li>approval_view -> approvalView</li>
    ...
    public static String columnToField(String columnName) {
        ...
        switch (columnName) {
            ...
            case "approval_view": return "approvalView";
